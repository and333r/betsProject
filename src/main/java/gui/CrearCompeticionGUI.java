...
public class CrearCompeticionGUI extends JFrame {
	...
	public CrearCompeticionGUI() {
		
		setTitle(ResourceBundle.getBundle("Etiquetas").getString("Crear") + ResourceBundle.getBundle("Etiquetas").getString("Competicion"));
		...
		lblIntroduceDatos = new JLabel(ResourceBundle.getBundle("Etiquetas").getString("NombreCompeticion"));
		...
		btnCrearCompeticion = new JButton(ResourceBundle.getBundle("Etiquetas").getString("Crear") + " " + ResourceBundle.getBundle("Etiquetas").getString("Competicion") + ".");
		btnCrearCompeticion.addActionListener(new ActionListener() {
			
			public void actionPerformed(ActionEvent e) {
				
				pulsadoCrearCompeticion();
				cerrarGUI();
			}
		});
	...
	private void pulsadoCrearCompeticion() {
		...
		if (this.comboBoxSexo.getSelectedIndex() * this.comboBoxTemporada.getSelectedIndex() == 0) {
			...
			this.lblErrores.setText("Por favor, seleccione tanto el genero como la temporada.");
		}else
		{
			char sexo = 'N';
