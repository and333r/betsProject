...
/**
 * Una competici�n que puede englobar un conjunto de eventos.
...
public class Competicion {
	...
	private char genero; //g�nero de los deportistas ('M' de masculino, 'F' de femenino, 'A' de mixto/Unisex).
	private String temporada;
	private String descripcion; //descripci�n opcional.
	@OneToMany (cascade =CascadeType.PERSIST)
	private Vector<Evento> eventos; //eventos de la competici�n.
	...
	/**
	 * A�ade un evento a la lista de eventos de esta competici�n.
	 * @param e el evento a a�adir.
	 */
